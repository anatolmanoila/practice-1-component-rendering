...
const planets = [
  {
    ...
    url:
      "https://uploads.codesandbox.io/uploads/user/c393b6a7-0840-428a-9f05-2a42b53eca08/_tIH-mercury.jpg"
  },
  {
    id: "2",
    name: "Venus",
    ...
    url:
      "https://uploads.codesandbox.io/uploads/user/c393b6a7-0840-428a-9f05-2a42b53eca08/ehfk-venus.jpg"
  },
  {
    id: "3",
    name: "Earth",
    ...
    url:
      "https://uploads.codesandbox.io/uploads/user/c393b6a7-0840-428a-9f05-2a42b53eca08/6B8V-earth.jpg"
  },
  {
    id: "4",
    name: "Mars",
  ...
  },
  {
    ...
    url:
      "https://uploads.codesandbox.io/uploads/user/c393b6a7-0840-428a-9f05-2a42b53eca08/rY0x-jupiter.jpg"
  },
  {
    id: "6",
    name: "Saturn",
...
const Planet = props => {
  return (
    <div className="card">
      ...
      <ul>
        <li>
          <strong>Diameter:</strong> {props.diameter} mi
        </li>
        <li>
...
ReactDOM.render(<App planets={planets} />, rootElement);
